    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex gap-2">
                <button type="button" class="rounded-lg px-4 py-2 text-sm font-medium text-zinc-600 transition hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800" @click="goBack">
                    Voltar
                </button>
            ...
            <aside class="space-y-5">
                <section class="rounded-lg border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
                    <dl class="space-y-3 text-sm">
                        ...
                        <div>
                            <dt class="text-xs uppercase tracking-wide text-zinc-400">Visibilidade</dt>
                            <dd class="mt-1 text-zinc-700 dark:text-zinc-300">{{ visibilityLabel(document.visibility) }}</dd>
                        </div>
                        <div>
